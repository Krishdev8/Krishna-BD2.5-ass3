...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  let result = sortedHotels.sort(sortByPricing(pricing));
  res.json({ hotels: result });
});

function sortingByRating(rating) {
  return (hotel1, hotel2) => {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let sortedHotels = hotels.slice();
  let result = sortedHotels.sort(sortingByRating(rating));
  res.json({ hotels: result });
});

function sortingByReviews(reviews) {
  return (hotel1, hotel2) => {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let sortedHotels = hotels.slice();
  let result = sortedHotels.sort(sortingByReviews(reviews));
  res.json({ hotels: result });
});

//4
function filterByAmenity(hotel, amenity) {
  return amenity.toLowerCase() === hotel.amenity.toLowerCase();
}
